# Домашнее задание к занятию "Отказоустойчивость в облаке" - `Леонов Алексей`
...
Terraform Playbook для задания 1 доступен по ссылке:
[playbook.yml](configs/playbook.yml)

**Скриншот 1: статус балансировщика:**
